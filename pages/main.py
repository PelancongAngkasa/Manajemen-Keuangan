...
if 'name' in st.session_state:
    st.subheader(f"Selamat datang, {html.escape(st.session_state['name'])}!")
...
if selected == "Masukkan Data":
    ...
    with st.form("entry_form", clear_on_submit=True):
        ...
        if submitted:
            ...
            catatan_sanitized = html.escape(catatan)
            db.insert_period(name, periode, total_pemasukan, total_pengeluaran, catatan_sanitized)
    ...
    if periods:
        ...
        if periode_data:
            with st.form("update_form", clear_on_submit=True):
                ...
                if submitted:
                    db.update_period(st.session_state['name'], period_to_edit, total_pemasukan, total_pengeluaran, catatan_sanitized)
    ...
    with st.form("saved_periods"):
        ...
        if submitted:
            ...
            if isinstance(periode_data, dict):
                ...
                st.text(f"Catatan: {html.escape(catatan)}")
